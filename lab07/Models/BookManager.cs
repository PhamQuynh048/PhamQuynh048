...
namespace lab07.Models
{
    class BookManager
    {
        public static List<Book> GetBooks()
        {
            ...
            books.Add(new Book { BookId = 10, Title ="Elit1", Author="Tempor", CoverImage="Assets/10.png"});
            books.Add(new Book { BookId = 11, Title ="Elit2", Author="Tempor", CoverImage="Assets/11.png"});
            books.Add(new Book { BookId = 12, Title ="Elit3", Author="Tempor", CoverImage="Assets/12.png"});
            books.Add(new Book { BookId = 13, Title = "elit3", Author = "tempor", CoverImage = "assets/13.png" });
            return books;
        }
    }
}
